...
//------- Email Check Before Update--------------//

if (isset($_REQUEST['action']) && $_REQUEST['action'] == "email_check_edit") {
    $email = isset($_POST['email']) ? $_POST['email'] : "";
...
if (isset($_POST['filter'])) {
    ...
    if ($res->num_rows > 0) {
        ...
        $output .= "<tr><td colspan='8' class='text-center'><h3>No Data Found At This Moment...!</h3></td></tr></table>";
        echo json_encode([
            'table' => $output,
            'pagination' => ""
        ]);

...
<body>
    ...
    <div id="container" class="form-div">
        ...
        <form method="post" action="" id="contactform">
            ...
            <div class="inp-div">
                <label>Email :</label>
                <input type="email" name="email" id="email" style="margin-left: 50px;" placeholder="Enter Your Email" value="<?php
                if (isset($email))
                    echo $email;
                ?>">
            ...
            <button type="submit" class="btn btn-primary"
                style="margin-left: 200px; padding: 7px 10px; border-radius: 5px; background-color: aqua; border: none;">Submit</button>
        </form>
    </div>
</body>
